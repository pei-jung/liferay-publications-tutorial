...
public interface FooLocalService
	extends BaseLocalService, CTService<Foo>, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>hello.service.impl.FooLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the foo local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link FooLocalServiceUtil} if injection and service tracking are not available.
	 */
